...
const inputFields = [
  { name: "hip", label: "The star's ID in the Hipparcos catalog.", type: "text", placeholder: "hip" },
  { name: "hd", label: "The star's ID in the Henry Draper catalog.", type: "text", placeholder: "hd" },
  { name: "hr", label: "The star's ID in the Harvard Revised catalog, which is the same as its number in the Yale Bright Star Catalog.", type: "text", placeholder: "hr" },
  ...
  { name: "ra", label: "Right ascension for epoch and equinox 2000.0.", type: "text", placeholder: "ra" },
  { name: "dec", label: "Declination for epoch and equinox 2000.0.", type: "text", placeholder: "dec" },
  { name: "dist", label: "The star's distance in parsecs.", type: "text", placeholder: "dist" },
  { name: "pmra", label: "The star's proper motion in right ascension.", type: "text", placeholder: "pmra" },
  { name: "pmdec", label: "The star's proper motion in declination.", type: "text", placeholder: "pmdec" },
  { name: "rv", label: "The star's radial velocity in km/sec.", type: "text", placeholder: "rv" },
  { name: "mag", label: "The star's apparent visual magnitude.", type: "text", placeholder: "mag" },
  { name: "absmag", label: "The star's absolute visual magnitude (its apparent magnitude from a distance of 10 parsecs).", type: "text", placeholder: "absmag" },
  { name: "spect", label: "The star's spectral type, if known.", type: "text", placeholder: "spect" },
  { name: "ci", label: "The star's color index (blue magnitude - visual magnitude), where known.", type: "text", placeholder: "ci" },
  { name: "x", label: "The star's cartesian x-coordinate in a system based on the equatorial coordinates as seen from Earth.", type: "text", placeholder: "x" },
  { name: "y", label: "The star's cartesian y-coordinate in a system based on the equatorial coordinates as seen from Earth.", type: "text", placeholder: "y" },
  { name: "z", label: "The star's cartesian z-coordinate in a system based on the equatorial coordinates as seen from Earth.", type: "text", placeholder: "z" },
  { name: "vx", label: "The star's cartesian x-velocity in a system based on the equatorial coordinates as seen from Earth.", type: "text", placeholder: "vx" },
  { name: "vy", label: "The star's cartesian y-velocity in a system based on the equatorial coordinates as seen from Earth.", type: "text", placeholder: "vy" },
  { name: "vz", label: "The star's cartesian z-velocity in a system based on the equatorial coordinates as seen from Earth.", type: "text", placeholder: "vz" },
  { name: "rarad", label: "The star's right ascension in radians.", type: "text", placeholder: "rarad" },
  { name: "decrad", label: "The star's declination in radians.", type: "text", placeholder: "decrad" },
  { name: "pmrarad", label: "The star's proper motion in right ascension in radians per year.", type: "text", placeholder: "pmrarad" },
  { name: "pmdecrad", label: "The star's proper motion in declination in radians per year.", type: "text", placeholder: "pmdecrad" },
  ...
  { name: "lum", label: "The star's luminosity as a multiple of that of the Sun.", type: "text", placeholder: "lum" },
  { name: "var", label: "The star's standard variable star designation, when known.", type: "text", placeholder: "var" },
  { name: "var_min", label: "The star's approximate magnitude range, for variables.", type: "text", placeholder: "var_min" },
  { name: "var_max", label: "The star's approximate magnitude range, for variables.", type: "text", placeholder: "var_max"
  }
];
